/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/jenkins_builder/workspace/EDSN_ToolChain-Linux64/build/tmp/work-shared/gcc-4.8.2-r0/gcc-4.8.2/gcc/config/i386/i386.md'.  */
